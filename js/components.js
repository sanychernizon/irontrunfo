var consoleMsg = document.querySelector('#msg-console');
...
var btnSortear = document.querySelector('.card');
var btnPartida = document.querySelector('#proxima-partida');
...
var rodada = document.querySelector('.rodada');
